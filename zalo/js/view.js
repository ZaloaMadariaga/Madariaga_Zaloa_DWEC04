            ...
            <div class="comparison-container">
                <div class="comparison-item">
                    <div class="movie">
                        ...
                        <p class="comparison-value"><strong>Puntuación:</strong> ${movie1.vote_average} ${voteAverageComparison1}</p>
                        <p class="comparison-value"><strong>Popularidad:</strong> ${movie1.popularity} ${popularityComparison1}</p>
                        <p class="comparison-value"><strong>Recaudación:</strong> $${movie1.revenue.toLocaleString()} ${revenueComparison1}</p>
                    </div>
                </div>
                <div class="comparison-item">
                    <div class="movie">
                        ...
                        <p class="comparison-value"><strong>Puntuación:</strong> ${movie2.vote_average} ${voteAverageComparison2}</p>
                        <p class="comparison-value"><strong>Popularidad:</strong> ${movie2.popularity} ${popularityComparison2}</p>
                        <p class="comparison-value"><strong>Recaudación:</strong> $${movie2.revenue.toLocaleString()} ${revenueComparison2}</p>
                    </div>
                </div>
            </div>
        </div>
